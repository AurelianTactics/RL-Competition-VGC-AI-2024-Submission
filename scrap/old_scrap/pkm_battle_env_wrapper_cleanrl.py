...
class PkmBattleEnvWrapperCleanRL(gym.Wrapper):
    '''
    '''
    def __init__(self, cleanrl_make_env):
        '''
        '''
        self.num_resets = -1
        ...
        self.opponent_agent = NiBotCleanRL()
        ...
        # pretty sure cleanrl wants it as a box and not Discrete
        self.observation_space = gym.spaces.Box(low=0., high=2.0, shape=(self.env.observation_space.n,), dtype=np.float32)
...
# Nizar's Bot
class NiBotCleanRL(BattlePolicy):
    '''
