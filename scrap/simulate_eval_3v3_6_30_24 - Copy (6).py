...
working
    ...
    DONE try some cmd line multiple runs    

    DONE works with 2v2 and 3v3
    ...
    DONE if 10k in a state and at elast 1k of each action, then can continue
    ...
    DONE could sort the party pkm but gets a little complicated
