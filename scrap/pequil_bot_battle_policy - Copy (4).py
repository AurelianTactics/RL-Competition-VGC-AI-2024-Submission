...
tune num moves revealed
maybe dict for if know opp best move against specific unit
'''
                        ...
                        if num_agent_pkm_non_fainted == 2 and num_opponent_pkm_non_fainted == 2:
                            ...
                            if state_key in self.two_vs_two_dict:
                                ...
                                if recommended_action != 0:
                                    ...
                                    if self.is_debug:
                                        print(f"Testing 2v2 recommending a swap {action}, recommended action {recommended_action}")
