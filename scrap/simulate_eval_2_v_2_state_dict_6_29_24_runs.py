...
working
    ...
    DONE step through and test
    DONE smoke test
    DONE run small sim
    run large sim
        see results
        num of dict states, num statistically significant states

    set up the eval stuff, see if any results
    ...
    not understanding why some dmg is being taken. not sure hwo to tell wtf is going on
        try seeing what is happenign somehow
