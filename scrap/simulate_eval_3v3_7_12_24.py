...
python simulate_eval_3v3_7_12_24.py --agent_team_size 2 --opp_team_size 2 --run_id 10 --num_battles 12 --run_tag 2v2smtest --is_eval 0
python simulate_eval_3v3_7_12_24.py --agent_team_size 2 --opp_team_size 3 --run_id 10 --num_battles 20000 --run_tag 2v3smtest --is_eval 0
python simulate_eval_3v3_7_12_24.py --agent_team_size 3 --opp_team_size 2 --run_id 10 --num_battles 20000 --run_tag 3v2smtest --is_eval 0
python simulate_eval_3v3_7_12_24.py --agent_team_size 3 --opp_team_size 3 --run_id 10 --num_battles 20000 --run_tag 3v3smtest --is_eval 0
...
def build_train_eval_loop(
    ...
    for battle_idx in range(num_battles):
        ...
        # can force a termination after one more step by setting this to 1
        turns_to_terminate = 1000000
        ...
        for episode_step in range(max_episode_steps):
            ...
            if is_3v3_battle:
                ...
                if turns_to_terminate > 1 and (agent_num_active_pkm < 3 or opp_num_active_pkm < 3):
                    turns_to_terminate = 1
                ...
                if turns_to_terminate > 1 and agent_num_active_pkm == 2 and opp_num_active_pkm == 2:
                    turns_to_terminate = 1


            if turns_to_terminate <= 0:
                terminated = True
        ...
        if battle_idx % 3000000 == 0 and battle_idx > 0:
...
def add_3v3_results_state_list_to_action_dict(
    ...
    for state_list_index, state_key in enumerate(state_list):
        if state_key == final_state_key:
            # don't put in final state key in this case as this result is not for win/loss usage
            continue
        # first move can be swap or attack, then attacking rest of the way
        if state_list_index == 0:
            move_key = agent_first_move
