...
python simulate_mc_v2_7_14_24 --run_id 10 --num_battles 12 --run_tag v2_mc_test 
    ...
    for battle_idx in range(num_battles):
        ...
        for episode_step in range(max_episode_steps):
            ...
            if num_agent_pkm >= 2 and num_opp_pkm >= 2:
                ...
                # only 1 pkm left on a side, both sides always attack
                agent_action = ...
                opp_action = ...
            ...
            # log results to dict
            # need: first state key, final results, move made
